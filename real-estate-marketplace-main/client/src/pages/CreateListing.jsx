...
function CreateListing() {
  ...
  const handleCreateListing = async (e) => {
    e.preventDefault(); 
    try {
      if(formData.imageUrls.length < 1) return setError('you must select an image');  
      if(+formData.regularPrice < +formData.discountPrice) return setError('Discount must strictly be lower than regular price');
      setError('');
      setLoading(true);
